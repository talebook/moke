            ...
            child: ListView(
              ...
              children: [
                ...
                if (user.isAdmin) ...[
                  ...
                  _buildNavItem(context, icon: Icons.admin_panel_settings, label: '系统设置', route: '/admin'),
                  _buildNavItem(context, icon: Icons.people_outline, label: '用户管理', route: '/admin'),
                  _buildNavItem(context, icon: Icons.menu_book, label: '书籍管理', route: '/admin'),
                  _buildNavItem(context, icon: Icons.drive_folder_upload, label: '导入管理', route: '/admin'),
                  const SizedBox(height: 12),
                ],
